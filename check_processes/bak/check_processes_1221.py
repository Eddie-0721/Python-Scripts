...
# def check_client(exe_name):
# # 查找所有正在运行的进程
#     for proc in psutil.process_iter(['name']):  
#         # 检查进程是否为指定的exe文件  
#         if proc.info['name'] == os.path.basename(exe_name):
...
#             # 终止进程
#             proc.kill()
#             logger.info(f"The client '{exe_name}' has been terminated.")
#             time.sleep(5)
#             return
# def close_client(exe_name):
#         # 获取所有正在运行的进程
...
#                 break
#         else:
#             logger.info(f"No running process found for '{exe_name}'.")
